...
export class Config {
           ...
           public static getDeploymentConfig(): DeploymentConfigInterface {
               return {
                   ...
                   documentation: {
                       ...
                       provider:
                           window["AppUtils"].getConfig().documentation?.provider ?? DocumentationProviders.GITHUB,
                       structureFileType:
           ...
           public static getUIConfig(): UIConfigInterface {
               return {
                   ...
                   applicationTemplateLoadingStrategy: window["AppUtils"].getConfig().ui
                   ...
                   isRequestPathAuthenticationEnabled: window["AppUtils"].getConfig().ui
            ...
            *
            *  @return {ExtensionsConfigInterface} - Extensions Config Object.
            *
            */
           public static getExtensionsConfig(): CommonExtensionsConfigInterface {
               return window["AppUtils"].getConfig().extensions;
           }
       }

...
export const SummaryUserStores: FunctionComponent<SummaryUserStoresPropsInterface> = (
    ...
    return (
        <Grid className="wizard-summary" data-testid={ testId }>
            ...
            <Divider horizontal>{ t("adminPortal:components.userstores.wizard.steps.general") }</Divider>
            ...
            <Divider horizontal>{ t("adminPortal:components.userstores.wizard.steps.user") }</Divider>

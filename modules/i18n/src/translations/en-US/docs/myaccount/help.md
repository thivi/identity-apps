...
3. Hover over the profile picture or the placeholder and click on the camera icon.
    ...
    ![profile-picture-hover](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/user-profile/profile-picture-hover.png)

4. In the pop-up that appears, enter the URL of the image that needs to be set as the profile picture in the textbox.

    ![profile-picture-url](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/user-profile/profile-picture-url.png)
...
3. Under the linked account sub section, click **Add account**.
    ...
    ![linked-account-add](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/linked-account/linked-acount-add.png)

4. Enter the username and the password of the account that needs to be linked and click **Save**.

    ![linked-account-save](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/linked-account/linked-account-save.png)
...
3. Under the **Export profile** sub section, click on the **Download as JSON** button. All the profile details will be downloaded to your local machine as a JSON file.
    ...
    ![profile-export](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/user-profile/profile-export.png)
...
4. Select an option depending on whether to add a USB security key or a built-in sensor.
    ...
    ![fido-options-list](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-options-list.png)

5. Click on **Continue**. Alternatively, click on the **Choose another option** dropdown to switch your option.

    ![fido-option-confirm](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-option-confirm.png)

6. Click on **Continue**. Alternatively, click on the **Choose another option** dropdown to switch your option.

    ![fido-option-allow](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-option-allow.png)

7. Add the preferred device name.

    ![fido-option-device-name](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-option-device-name.png)

8. Once the device is successfully added, the registered device will be listed along with its name.

    ![fido-devices-list](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-devices-list.png)
...
1. Click **close**.
    ...
    ![fido-device-old](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-device-old.png)


2. Click **Try with an older Device**.

    ![fido-device-old-error](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-device-old-error.png)
...
![fido-device-delete](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/account-recovery/fido-device-delete.png)
...
![pending-approvals-all](/myaccount/resources/assets/myaccount/img/using-wso2-identity-server/user-portal/pending-approvals/pending-approvals-all.png)

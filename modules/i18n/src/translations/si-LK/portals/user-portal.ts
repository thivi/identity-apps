    ...
    components: {
        ...
        overview: {
            widgets: {
                ...
                accountStatus: {
                  email: {
                        errorMessage: "ඔබ ප්‍රතිසාධන විද්‍යුත් තැපෑලක් සකසා නැත. එකක් සැකසීමට ආරක්ෂක පිටුවට යන්න.",
                        label: "ප්‍රතිසාධන විද්‍යුත් තැපෑල",
                        successMessage: "ඔබට ප්‍රතිසාධන විද්‍යුත් තැපෑලක් ඇත. හොඳට කලා!"
                    },
                    mfa: {
                        errorMessage: "ඔබ බහු සාධක සත්‍යාපනය වින්‍යාස කර නොමැත."
                            + "ආරක්ෂක පිටුවේ බහු-සාධක සත්‍යාපන විකල්පයක් වින්‍යාස කරන්න.",
                        label: "බහු සාධක සත්‍යාපනය",
                        successMessage: "ඔබට බහු-සාධක සත්‍යාපනය වින්‍යාස කර ඇත."
                            + "මෙය ඔබගේ ගිණුමට අමතර ආරක්ෂිත තට්ටුවක් එක් කරයි."
                    },
                    securityQuestions: {
                        errorMessage: "ඔබ කිසිදු ආරක්ෂක ප්‍රශ්නයක් වින්‍යාස කර නොමැත."
                            + "ආරක්ෂක පිටුවේ ඒවා වින්‍යාස කරන්න.",
                        label: "ආරක්ෂක ප්‍රශ්න",
                        successMessage: "ඔබට ආරක්ෂක ප්‍රශ්න වින්‍යාස කර ඇත."
                            + "ඔබගේ මුරපදය අමතක වූ විට ඔබගේ ගිණුම අය කර ගැනීමට ඔබට ඒවා භාවිතා කළ හැකිය."
                    },
                    userSessions: {
                        errorMessage: "ඔබට පසුගිය මාසයක් තුළ ප්‍රවේශ නොවූ පරිශීලක සැසි ඇත."
                            + " ආරක්ෂක ගැටළු වළක්වා ගැනීම සඳහා එම සැසි අවසන් කරන්න.",
                        label: "පැරණි පරිශීලක සැසි නොමැත",
                        successMessage: "ඔබ මාසයක් තුළ ප්‍රවේශ නොවූ සැසි නොමැත. නියමයි!"
                    }
                },
                consentManagement: {
                    actionTitles: {

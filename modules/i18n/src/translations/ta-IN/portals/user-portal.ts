    ...
    components: {
        ...
        overview: {
            widgets: {
                ...
                accountStatus: {
                    email: {
                        errorMessage: "மீட்டெடுப்பு மின்னஞ்சலை நீங்கள் அமைக்கவில்லை. " +
                            "ஒன்றை அமைக்க பாதுகாப்பு பக்கத்திற்குச் செல்லவும்.",
                        label: "மீட்பு மின்னஞ்சல்",
                        successMessage: "உங்களிடம் மீட்பு மின்னஞ்சல் உள்ளது. நல்லது!"
                    },
                    mfa: {
                        errorMessage: "நீங்கள் பல காரணி அங்கீகாரத்தை உள்ளமைக்கவில்லை."
                            + "பாதுகாப்பு பக்கத்தில் பல காரணி அங்கீகார விருப்பத்தை உள்ளமைக்கவும்.",
                        label: "பல காரணி அங்கீகாரம்",
                        successMessage: "உங்களிடம் பல காரணி அங்கீகாரம் உள்ளமைக்கப்பட்டுள்ளது."
                            + " இது உங்கள் கணக்கிற்கு கூடுதல் பாதுகாப்பு அளிக்கின்றது."
                    },
                    securityQuestions: {
                        errorMessage: "நீங்கள் எந்த பாதுகாப்பு கேள்விகளையும் உள்ளமைக்கவில்லை."
                            + "பாதுகாப்பு பக்கத்தில் அவற்றை உள்ளமைக்கவும்.",
                        label: "பாதுகாப்பு கேள்விகள்",
                        successMessage: "உங்களிடம் பாதுகாப்பு கேள்விகள் உள்ளமைக்கப்பட்டுள்ளன."
                            + "உங்கள் கடவுச்சொல்லை மறந்துவிட்டால் உங்கள் கணக்கை மீட்டெடுக்க அவற்றைப் பயன்படுத்தலாம்."
                    },
                    userSessions: {
                        errorMessage: "கடந்த ஒரு மாதத்தில் அணுகப்படாத பயனர் அமர்வுகள் உங்களிடம் உள்ளன."
                            + " பாதுகாப்பு சிக்கல்களைத் தவிர்க்க அந்த அமர்வுகளை நிறுத்தவும்.",
                        label: "பழைய பயனர் அமர்வுகள் இல்லை",
                        successMessage: "ஒரு மாதத்தில் நீங்கள் அணுகாத அமர்வுகள் எதுவும் இல்லை. சிறந்தது!"
                    }
                },
                consentManagement: {
                    actionTitles: {
